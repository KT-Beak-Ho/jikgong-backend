...
public class JobPostListResponse {
    ...
    public static JobPostListResponse from(JobPost jobPost, List<WorkDateResponse> availableDate, List<WorkDateResponse> unavailableDate, List<WorkDateResponse> pastDate) {
        return JobPostListResponse.builder()
                .jobPostId(jobPost.getId())
                .tech(jobPost.getTech())
                .title(jobPost.getTitle())
                .availableDate(availableDate)
                .fullCapacityDate(unavailableDate)
                .pastDate(pastDate)
