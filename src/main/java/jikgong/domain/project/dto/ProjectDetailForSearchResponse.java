...
@Getter
@Builder
public class ProjectDetailForSearchResponse {
    ...
    public static ProjectDetailForSearchResponse from(Project project, List<WorkDate> workDateList) {
        List<JobPostResponse> jobPostResponseList = workDateList.stream()
            .map(JobPostResponse::from)
            .collect(Collectors.toList());

        return ProjectDetailForSearchResponse.builder()
