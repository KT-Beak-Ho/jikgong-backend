...
@OpenAPIDefinition(
        info = @Info(title = "jikgong API 명세서",
                description = "노동자 계정: 아래 3개   " +
                        "\neyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwaG9uZSI6IjAxMDEyMzQ1Njc4IiwiZXhwIjoxNzA5NjQwMzc5fQ.KmnnBZIP2uDI3GeJFoaMETmI2326S_kTLYr4-y4mfzs  " +
