...
public class DistanceCal {
    ...
    public static Double getDistance(Address projectAddress, Location location) {
        double earthRadius = 6371; // 지구 반지름
        ...
        // 일자리 위치
        double lat2 = Math.toRadians(projectAddress.getLatitude());
        double lon2 = Math.toRadians(projectAddress.getLongitude());
